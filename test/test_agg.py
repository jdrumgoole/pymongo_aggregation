...
from pymongo_aggregation.agg_operation import Agg_Operation, match
...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        self._client = pymongo.MongoClient( host="mongodb://localhost:27017/testgg")
        self._mdb = self._client[ "testagg"]
